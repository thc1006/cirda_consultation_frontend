<script lang="ts">
  ...
  // 校內資源同時列出兩校區，受試者依所在校區挑選
  const lines = [
    { name: '衛福部安心專線 1925', tel: '1925', note: '24 小時免付費' },
    { name: '生命線 1995', tel: '1995', note: '24 小時' },
    { name: '張老師 1980', tel: '1980', note: '週一至日皆有時段' },
    { name: '陽明校區 健康心理中心', tel: '0228267000,62026', note: '日間預約' },
    { name: '交大校區 健康心理中心', tel: '035712121,51303', note: '日間預約' },
    { name: '陽明校區 校安中心', tel: '0228261100', note: '24 小時' },
    { name: '交大校區 校安中心', tel: '035712121,31999', note: '24 小時' }
  ];
</script>
